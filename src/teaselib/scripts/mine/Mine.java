...
public class Mine extends Player {
    ...
    private void mapToysToMultipleItems() {
        ...
        state.addScriptValueMapping(MappedScriptState.Global,
                new MappedScriptItemValue(389, items(Toys.Cock_Ring).queryInventory(Features.Vibrating),
                        items(Toys.VaginalInsert).queryInventory(Features.Vibrating),
                        items(Toys.Vibrator).queryInventory(Features.HandsFree), items(Toys.EStim_Device)));
    }
